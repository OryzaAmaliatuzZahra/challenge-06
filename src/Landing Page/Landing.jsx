...
function Landing() {
  ...
  <header>
    <nav className="navbar navbar-expand-lg fixed-top pxc-7">
      <a className="navbar-brand" href="/"><img className="col-md-auto p-0" src="img/logo.svg" alt /></a>
      ...
      <div className="offcanvas offcanvas-end w-50" tabIndex={-1} id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
        ...
        <div className="offcanvas-body">
          <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
            <li className="nav-item"><a className="nav-link" href="#our-service-section">Our Service</a></li>
  ...
  <article id="home" className="row align-items-end">
    <div className="col home-content align-self-center">
      <h2 className="mb-5 font-weight-bold">Sewa &amp; Rental Mobil Terbaik di kawasan Karawang</h2>
  ...
  <section id="our-service-section">
      <div className="container our-service pt-5">
        <div className="row align-items-center justify-content-center">
          <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-center me-4">
            <img src="img/img_service.png" width="150%" className="img-fluid" id="service-img" />
          </div>
          <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <h2 className="mb-3 fw-bold">Best Car Rental for any kind of trip in Karawang</h2>
            <p>Sewa mobil di Karawang bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain,
              kondisi mobil baru, serta kualitas pelayanan terbaik untuk perjalanan wisata, bisnis, wedding,
              meeting, dll.</p>
            <p>
              <span><img src="img/check.svg" alt="checklist" width="24px" className="me-2" /></span>
